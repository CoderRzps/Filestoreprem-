...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002692444242"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002301871490"))
...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7478730845:AAG3g8-KEcA-GKjy_kvQQU1fXglsRzTOUg8") 
...
OWNER_ID = int(os.environ.get("OWNER_ID", "8148618386"))
...
OWNER_TAG = os.environ.get("OWNER_TAG", "lakshya_919")
...
TUT_VID = os.environ.get("TUT_VID","https://t.me/APSmo/14")
...
#custom caption 
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @crunchy_rolll</b>")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6508598835 8148618386").split()):
        ADMINS.append(int(x))
except ValueError:
